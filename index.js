...
*/
 ...
 if (votingAge >= 18) {
  console.log ('task 1 a:', "You're able to vote!");
}
  else  {
    console.log ('task 1 a:', "You can't vote.");
  }
...
*/
let person = 'Cliff';
let dance = 'tootsieRoll';
 
if(dance === 'tootsieRoll'){
  person = 'Rob';
}else{
  person = 'Cliff';
}
...
const danceSong = "1999"
console.log('task 1 c:', Number(danceSong))
...
console.log('task 1 d:', multiply(6, 8))
...
function annoyingSong(number){
      for(let i = number; i > 0; i--){
        return `${number} bottles of soda on the wall, ${i} bottles of soda, take one down pass it around 
        ${i -1} bottles of soda on the wall`;
      }
}

console.log('task 6', annoyingSong(84));
